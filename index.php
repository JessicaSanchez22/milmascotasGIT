...
<body background="images/fondo.jpg" style="background-size: cover;" style="text-decoration-color: #fefefe;">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="wrapper-page">
                        <div class="m-t-40 card-box" style="background:rgba(1,1,1,.3);">
                            ...
                            <div class="account-content">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group m-b-20">
                                        <div class="col-xs-12">
                                            <a href="#" class="text-muted pull-right font-14"><font color= "blue">¿Olvidaste tu contraseña?</font></a>
                                    ...
                                    <div class="form-group account-btn text-center m-t-10">
                                        <div class="col-xs-12">
                                            <button class="btn btn-lg btn-primary btn-block" type="submit"><a href="dashboard.php">Entrar</a></button>
                                        </div>
                                    </div>
                        ...
                        <div class="row m-t-50">
                            <div class="col-sm-12 text-center">
                                <p class="text-muted"><font color="black">¿No tienes una cuenta? </font><a href="registro.php" class="text-dark m-l-5"><font color="blue">Registrate</a></p>
                            </div>
                        </div>

        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="images/chica.png" alt="User profile picture">

              <h3 class="profile-username text-center">Regina George</h3>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Contactos</b> <a class="pull-right">13,287</a>
                </li>
              </ul>

              <a href="#" class="btn btn-primary btn-block"><b>Seguir a</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                B.S. Graduada de la Universidad Politecnica de Victoria
              </p>
              ...
              <strong><i class="fa fa-pencil margin-r-5"></i>Cualidades</strong>

              <p>
                <span class="label label-danger">Diseño</span>
                <span class="label label-success">Me gusta cuidar animales</span>
              </p>
              ...
              <p>Soy algo intolerante cuando estoy hambrienta.</p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="images/familia.png" alt="user image">
                        <span class="username">
                          <a href="#">Jonathan Burke Jr.</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                    <span class="description">Publicidad - 7:30 PM hoy</span>
                  </div>
                  <!-- /.user-block -->
                  <p>
                    Sabes, me gustaria platicar contigo acerca de proporcionarle publicidad a tu tienda de mascotas,
                    si te interesa puedes dejarme un mensaje.
                  </p>
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="images/gato.png" alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                    <span class="description">Te envio un mensaje - hace 3 días</span>
                  </div>
                  <!-- /.user-block -->
                  <p>
                    Crees que exista la posibilidad de trabajar en tu tienda? Llamame.
                  </p>

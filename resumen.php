      ...
      <!-- /.search form -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="agregarCliente.php"><i class="fa fa-circle-o"></i> Agregar nuevo</a></li>
            <li><a href="consultaCliente.php"><i class="fa fa-circle-o"></i> Consultar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Citas</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="calendario.php"><i class="fa fa-circle-o"></i> Agendar cita</a></li>
          </ul>
        </li>
        <li>
		...
		<div class="container">
			<div class="row">
              ...
              <h3 class="box-title">Reporte mensual</h3>
                            ...
                            <div class="col-sm-12">
                                <h4 class="m-t-0 header-title">Consulta de las mascotas registradas este mes</h4>

      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <div class="icon">
              <i class=""><img src="images/gato.png"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Aumento en las ventas</p>
            </div>
            <div class="icon">
              <i class=""><img src="images/cardiograma.png"></i>
            </div>
            <a href="#" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <div class="icon">
              <i class=""><img src="images/familia.png"></i>
            </div>
            <a href="#" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Medicamentos vendidos</p>
            </div>
            <div class="icon">
              <i class=""><img src="images/pastillas.png"></i>
            </div>
            <a href="#" class="small-box-footer">Más información<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Total en ventas los ultimos años</li>
            </ul>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Recoger a la mascota de los Clark</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Entregar la mascota de los Jenkins</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Limpiar la jaula de los conejos</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Hacer pago a proveedor</span>
            ...
            <div class="box-footer clearfix no-border">
              <button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Agregar nueva tarea</button>
            </div>
          </div>
          <!-- /.box -->
        ...
        <section class="col-lg-5 connectedSortable">
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Mascotas entregadas</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  <div id="sparkline-2"></div>
                  <div class="knob-label">Mascotas por entregar</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  <div id="sparkline-3"></div>
                  <div class="knob-label">Mascotas devueltas</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
          ...
          <div class="box box-solid bg-teal-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Indice de medicamentos</h3>
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Rabia</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Dolor estomacal</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  ...
                  <div class="knob-label">Moquillo</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
